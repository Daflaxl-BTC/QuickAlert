...
export const metadata: Metadata = {
  title: 'EU-Konformitätserklärung — QuickAlert PRO',
  description:
    'EU-Konformitätserklärung (Declaration of Conformity) für QuickAlert PRO gemäß den anwendbaren EU-Richtlinien und -Verordnungen.',
  alternates: { canonical: 'https://quickalert.eu/doc/pro' },
}

const PDF_HREF = '/compliance/doc-pro.pdf'

export default function DocPro() {
  return (
      ...
      <section className="px-6 sm:px-8 lg:px-12 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-zinc-900 mb-4 tracking-tight">
            EU-Konformitätserklärung — QuickAlert PRO
          </h1>
          <p className="text-zinc-600 mb-8 leading-relaxed">
            Diese Seite stellt die EU-Konformitätserklärung (Declaration of Conformity) für QuickAlert PRO
